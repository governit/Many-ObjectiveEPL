experiment2_2FM = read.csv("./Experiments segundo paper/Experiment4/experiment40FMs.csv")
...
experiment2_3FM = read.csv("./Experiments segundo paper/Experiment4/experiment80FMs.csv")
...
experiment2_4FM = read.csv("./Experiments segundo paper/Experiment4/experiment120FMs.csv")
...
experiment2_5FM = read.csv("./Experiments segundo paper/Experiment4/experiment160FMs.csv")
...
experiment2_6FM = read.csv("./Experiments segundo paper/Experiment4/experiment200FMs.csv")
...
pdf(file="./Experiments segundo paper/Experiment4/experiment42.pdf",width=10) 
par(mfrow=c(2,3))
par(mar=c(4,4,1,1))
